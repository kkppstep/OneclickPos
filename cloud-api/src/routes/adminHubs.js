...
// POST /admin/stores/:storeId/provisioning-codes — an owner or manager
// calls this from the dashboard when physically setting up a new hub
// device. The returned code is short-lived and single-use, safe to
// read aloud or type in during setup.
router.post('/admin/stores/:storeId/provisioning-codes', authenticateUser, requireStoreRole(['owner', 'manager']), async (req, res) => {
